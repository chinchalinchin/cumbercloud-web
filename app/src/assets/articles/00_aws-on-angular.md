...
**NOTE**: The template, *cloudformation.yml*, must be saved in the directory *where this command is executed*. If you try to point this command to the location of the template, it will cause endless headaches as you struggle to figure out what the problem is. 
...
4. **domainName**: This is the domain name you registered in or transferred to **Route53**. Do not include the *https://* or *www* in the value. 
